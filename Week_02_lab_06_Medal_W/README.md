...
// \[for\] and \[foreach\] can be used in all below question (Just
Chosen one)

Console.WriteLine("\n----- Q1. Prints a numbered list of all athletes 16
medals -----");
...
Console.WriteLine("\n----- Q2. Prints a numbered list of 16 athlete's
names -----");
...
Console.WriteLine("\n----- Q3. Prints a numbered list of 9 athletes who
got gold medals -----");
...
Console.WriteLine("\n----- Q4. Prints a numbered list of 9 athletes with
medals in 2012 -----");
...
Console.WriteLine("\n----- Q5. Prints a numbered athletes list of 3
world record medals -----");
